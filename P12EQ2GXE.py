...
#P12EQ2GXE.py: classifica a equação do segundo grau segundo suas raízes, e as calcula com eficiência
...
#BOAS VINDAS
print("Bem vindo ao programa P12EQ2GXE: classifica a equação do segundo grau da forma Ax^2+Bx+C=0 segundo suas raízes, e as calcula")
#DIÁLOGO DE ENTRADA
